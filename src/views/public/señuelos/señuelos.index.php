...
try {
    ...
    $señuelos = $productoModel->getByCategory('señuelos');
...
<body class="bg-gray-100 text-[var(--text-color)]">
    ...
    <section class="bg-gray-100 py-16">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <a href="index.php?route=admin/señuelos/create"
