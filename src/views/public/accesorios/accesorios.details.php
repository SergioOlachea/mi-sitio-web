...
<head>
    ...
    <title><?= htmlspecialchars($accesorio->nombre) ?></title>
</head>
...
<section class="py-16">
    <div class="max-w-5xl mx-auto px-6 bg-white rounded-xl shadow-lg p-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
                <?php 
                    $imageUrl = $accesorio->imagen_url ? $accesorio->imagen_url : 'placeholder_accesorio.jpg';
            ...
            <div class="flex flex-col justify-between">
                ...
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-600 mb-6">
                        $<?= number_format($accesorio->precio, 2) ?>
                    </p>
                </div>
                ...
                <div class="flex flex-col gap-4 mt-4">
                    ...
                    <a href="index.php?route=accesorios"
