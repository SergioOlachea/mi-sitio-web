    ...
    <div class="bg-white shadow-lg rounded-xl p-8 w-full max-w-lg">
        ...
        <form action="<?= isset($señuelos) ? 'index.php?route=admin/carretes/edit/'.$señuelos->id : 'index.php?route=admin/carretes/create' ?>" 
            ...
            <div>
                ...
                <input type="text" name="nombre" value="<?= $señuelos->nombre ?? '' ?>" 
            ...
            <div>
                ...
                <textarea name="descripcion" rows="4" 
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required><?= $señuelos->descripcion ?? '' ?></textarea>
            </div>

            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block font-medium mb-1">Precio:</label>
                    <input type="number" step="0.01" name="precio" value="<?= $señuelos->precio ?? '' ?>" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
                <div>
                    <label class="block font-medium mb-1">Stock:</label>
                    <input type="number" name="stock" value="<?= $señuelos->stock ?? 0 ?>" min="0"
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="categoria" value="<?= $señuelos->categoria ?? 'carretes' ?>" 
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            </div>
            ...
            <div>
                ...
                <?php if(isset($señuelos) && $señuelos->imagen_url): ?>
                    <img src="public/assets/img/<?= $señuelos->imagen_url ?>" alt="Imagen" class="mt-2 w-32 h-32 object-cover rounded">
                <?php endif; ?>
            </div>
            ...
            <div class="text-center mt-6">
                <button type="submit" 
                    ...
                    <?= isset($señuelos) ? 'Actualizar' : 'Agregar' ?>
                </button>
            </div>
